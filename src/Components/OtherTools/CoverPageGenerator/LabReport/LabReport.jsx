...
const LabReport = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        const blob = await pdf(<LabReportDocument formData={formData} />).toBlob();
            ...
            {!submitted ? (
                <form onSubmit={handleSubmit}>
                    <div className="grid grid-cols-3 p-4 sm:grid-cols-1 text-center justify-center items-center">
                        ...
                        <div className="mt-10 flex flex-col p-2">
                            <label>
                                <h1 className="text-left">Experiment No:</h1>
                                <input
                                    className="input input-bordered w-full"
                                    type="text"
                                    name="expNo"
                        ...
                        <div className="mt-10 flex flex-col p-2">
                            <label>
                                <h1 className="text-left">Experiment Name:</h1>
                                <input
                                    className="input input-bordered w-full"
                                    type="text"
                                    name="expName"
                ...
                <div className="flex items-center justify-center h-[30vw]">
                    ...
                    <PDFDownloadLink
                        ...
                        document={<LabReportDocument formData={formData} />}
                        fileName={`Lab-Report_${formData.name}_${formData.studentId}_${formData.submissionDate}`}
                    >
                        {({ loading }) =>
