...
const LabReportDocument = ({ formData }) => (
    <Document>
        <Page size="A4" style={styles.page}>
            <View style={styles.contentContainer}>
                ...
                <View style={styles.section}>
                    ...
                    <Text style={styles.text}>Experiment No: {formData.expNo}</Text>
                    <Text style={styles.text}>Experiment Name: {formData.expName}</Text>
                </View>
